...
insert into emp values(emp_seq.nextval, 'emp01', 'emp01123', '직원일', '010-8888-8888', '내가 좋아하는 캐릭터는?', '올라프', '');
insert into emp values(emp_seq.nextval, 'emp02', 'emp02123', '직원이', '010-7777-7777', '내가 좋아하는 캐릭터는?', '둘리', '');
insert into mb values(mb_seq.nextval, 'mb01', 'mb011234', '학생일', '010-6666-6666', '다시 태어나면 되고 싶은 것은?', '토토로');
insert into mb values(mb_seq.nextval, 'mb02', 'mb021234', '학생이', '010-5555-5555', '다시 태어나면 되고 싶은 것은?', '올라프');
insert into mb values(mb_seq.nextval, 'mb03', 'mb031234', '학생삼', '010-4444-4444', '다시 태어나면 되고 싶은 것은?', '둘리');
commit;