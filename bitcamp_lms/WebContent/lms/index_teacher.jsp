<%@page import="com.bit.lms.model.Index_TeacherDto"%>
			...
			<div class="container">
				...
				<div id="gnb" class="gnb_area">
					...
					<ul>
						...
						<li><a href=""> <i class="xi-book-o"></i> <span>나의
									교육과정</span>
					...
					<div class="dashboard_wrap">
						...
						<div>
							...
							<div class="profile box">
								...
								<p class="btn_go">
									<a href="lock.html">내 정보 수정 <i class="xi-arrow-right"></i></a>
								</p>
							...
							<div class="class box">
								...
								<div>
									...
									<dl>
										...
										<dt>디지털컨버전스 기반 자바 Open Source Web application 전문 개발자 양성과정
											- 3월</dt>

										<dd>
											2020.01.01 ~ 2020.03.31 <span>[수강 진행 중]</span>
										</dd>
							...
							<div class="board box">
								...
								<div>
									...
									<ul>
									<%
									ArrayList<Index_TeacherDto> list=null;
									list=(ArrayList<Index_TeacherDto>)request.getAttribute("index_teacherlist");
									for(int i=0; i<list.size(); i++){
										if(i==5)break;
										Index_TeacherDto bean=list.get(i);
									%>
										<li><a href="teachernoticedetail.html?idx=<%=bean.getCls_no()%>"><span><%=bean.getCls_subject() %></span><span><%=bean.getCls_date() %></span></a></li>
									<%} %>
									</ul>
										<!-- 게시물이 없을 때
								...
								<p class="btn_go">
									<a href="teachernotice.html">자세히 보기 <i class="xi-arrow-right"></i></a>
								</p>
