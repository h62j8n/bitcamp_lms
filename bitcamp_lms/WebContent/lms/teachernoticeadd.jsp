...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="container">
			...
			<h1><a href="../lms/index_teacher.html"><img src="../images/ico/logo_w.png" alt="비트캠프 구리센터"></a></h1>
					...
					<form method="post">
						...
						<table class="table box">
							...
							<tr>
								...
								<th><label for="cls_subject">제목</label></th>

								<td>

									<input type="text" name="cls_subject" id="cls_subject">
							...
							<tr>
								...
								<th><label for="cls_content">내용</label></th>

								<td>

									<textarea name="cls_content" id="cls_content"></textarea>
