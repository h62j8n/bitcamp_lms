<%@page import="com.bit.home.model.NoticeDetailDto"%>
...
<div id="header">
	<div class="container">
		<h1><a href="/bitcamp_lms/home/index.html"><img alt="비트캠프 구리센터" src="../images/comm/logo.png"></a></h1>
			...
			<div class="container">
				...
				<div class="table-style style2">
					<table>
						...
						<tbody>
							<%
							NoticeDetailDto bean=(NoticeDetailDto)request.getAttribute("noticedetail");
							%>
							<tr>
								<th>제목</th>
								<td colspan="3"><%=bean.getNtc_subject() %></td>
							</tr>
							<tr>
								<th>작성일</th>
								<td><%=bean.getNtc_date() %></td>
								<th>조회수</th>
								<td><%=bean.getNtc_count()%></td>
							</tr>
							<tr>
								<td colspan="4" >
									<div class="text-box">
		                            <p><%=bean.getNtc_content()%></p>
									</div>
								</td>
							</tr>
						</tbody>
